...
<head>
    <meta charset="UTF-8">
    <title>Your E-Waste Account Login Credentials</title>
</head>
                    ...
                    <tr>
                        <td style="background:#172554;padding:28px 30px;text-align:center;">
                            ...
                            <p style="margin:8px 0 0;color:#bfdbfe;font-size:14px;">
                                Smart e-waste tracking and pickup platform
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:32px 30px;">
                            ...
                            <p style="margin:0 0 18px;color:#334155;font-size:15px;line-height:24px;">
                                Your company account has been created successfully. Use the credentials below to login to the E-Waste platform.
                            </p>
                                ...
                                <tr>
                                    <td style="padding:18px 20px;">
                                        ...
                                        <p style="margin:0;color:#475569;font-size:14px;">
                                            ...
                                            <span style="color:#0f172a;font-weight:bold;">{{ $temporaryPassword }}</span>
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p style="margin:24px 0 0;color:#64748b;font-size:13px;line-height:21px;">
                                If you did not request this account, please ignore this email or contact the administrator.
                            </p>
                        </td>
                    </tr>
